            ...
            <form onSubmit={manejarSubmit} className="formulario-cuenta">
              <div className="grupo-formulario">
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  title="Ingrese solo digitos"
                  placeholder="Ej: 1101, 2101, 5101"
                  value={nuevaCuenta.codigo}
                  onChange={(e) =>
                    setNuevaCuenta({ ...nuevaCuenta, codigo: e.target.value })
                  }
                  required
                />
                <span className="texto-ayuda">
                  Código numérico único para la cuenta
                </span>
              </div>
              ...
              <div className="grupo-formulario">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNuevaCuenta({ ...nuevaCuenta, nombre: e.target.value })
                  }
                  required
                />
              </div>
              ...
              <div className="grupo-formulario">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNuevaCuenta({ ...nuevaCuenta, tipo: e.target.value })
                  }
                >
              ...
              <div className="form-acciones">
                <button type="submit" className="btn-form-primary">
                  {cuentaEditando ? "Actualizar cuenta" : "Agregar cuenta"}
                </button>
                            ...
                            >
                              ...
                              >
                                <path
                                  ...
                                  strokeLinejoin="round"
                                  strokeWidth="2"
                                  d="M16.862 3.487l2.651 2.651m-2.651-2.651L9.75 10.6a2 2 0 00-.5.9l-.6 2.4 2.4-.6a2 2 0 00.9-.5l7.112-7.113m-2.65-2.65l-1.18-1.18a1.5 1.5 0 00-2.121 0L8.57 5.57a2 2 0 00-.5.9l-.6 2.4 2.4-.6a2 2 0 00.9-.5l4.95-4.95a1.5 1.5 0 000-2.121z"
                                />
                              </svg>
                              <span>Editar</span>
                            </button>
