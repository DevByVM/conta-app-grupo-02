...
const LibroMayor = ({ proyecto, usuario }) => {
  ...
  const cargarDatos = async () => {
    try {
      setCargando(true);
      console.log('Cargando datos para proyecto:', {
        usuario: usuario?.uid,
  ...
  useEffect(() => {
    if (cuentaSeleccionada && proyecto && usuario) {
      filtrarMovimientosPorCuenta();
    }
  }, [cuentaSeleccionada, transacciones, proyecto, usuario]);
      ...
      <div className="libro-mayor">
        <div className="estado-vacio">
          ...
          <p className="descripcion-vacio">
            Para ver el libro mayor, primero selecciona un proyecto
          </p>
        </div>
      </div>
    );
      ...
      <div className="contenedor-principal">
        <div className="cabecera-seccion">
          <div className="titulo-grupo">
            ...
            <p className="subtitulo">
              Proyecto: <strong>{proyecto.nombre}</strong> - Movimientos detallados y saldos por cuenta contable
            </p>
        ...
        {cargando ? (
          <div className="estado-cargando">
            ...
            <p className="texto-cargando">Cargando datos del proyecto...</p>
          </div>
        ) : (
              ...
              {cuentaSeleccionada ? (
                  ...
                  <div className="panel-movimientos">
                    <div className="cabecera-panel">
                      <h2 className="titulo-panel">
                        ...
                        Movimientos de Cuenta - {proyecto.nombre}
                      </h2>
                    ...
                    <div className="contenedor-lista">
                      {movimientosFiltrados.length === 0 ? (
                        <div className="estado-vacio">
                          ...
                          <p className="descripcion-vacio">
                            Registre transacciones en los módulos de Ventas o Compras para generar movimientos en este proyecto
                          </p>
                        </div>
                      ) : (
                ...
                <div className="estado-seleccion">
                  ...
                  <p className="descripcion-seleccion">
                    Elija una cuenta del catálogo del proyecto <strong>{proyecto.nombre}</strong> para visualizar sus movimientos y saldo actual
                  </p>
                </div>
              )}
            </div>
